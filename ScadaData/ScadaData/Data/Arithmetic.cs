...
namespace Scada.Data
{
    ...
    /// <para>¬спомогательные математические расчЄты</para>
    /// </summary>
    public static class Arithmetic
    {
        /// <summary>
        /// Ќачало отсчЄта времени в Delphi
        /// </summary>
        private static readonly DateTime DelphiTimeBegin = new DateTime(1899, 12, 30);

        /// <summary>
        /// ¬ыделить час, минуту и секунду из вещественного значени€ времени формата Delphi
        /// </summary>
        public static void DecodeTime(double time, out int hour, out int min, out int sec)
        {
            ...
            time += ms;
            time -= Math.Truncate(time); // (int)time работает некорректно дл€ чисел time > int.MaxValue
            hour = (int)(time * 24);
            time -= hour * hh;
            min = (int)(time * 24 * 60);
            time -= min * mm;
        ...
        /// <summary>
        /// ѕреобразовать дату и врем€ в формат DateTime из вещественного значени€ времени формата Delphi
        /// </summary>
        ...
        /// <summary>
        /// «акодировать дату и врем€ в вещественное значение времени формата Delphi
        /// </summary>
        ...
        /// <summary>
        /// »звлечь дату из имени файла (без директории) таблицы срезов или событий
        /// </summary>
