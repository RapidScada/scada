    ...
    public class CommShell
    {
        ...
        public Dictionary<string, Image> GetTreeViewImages()
        {
            return new Dictionary<string, Image>
            {
                ...
                { "comm_line_params.png", Resources.comm_line_params },
        ...
        public TreeNode[] GetTreeNodes(Settings settings, CommEnvironment environment)
        {
            ...
            nodes.Add(
                new TreeNode(CommShellPhrases.CommonParamsNode)
                {
            ...
            nodes.Add(
                new TreeNode(CommShellPhrases.DriversNode)
                {
            ...
            foreach (Settings.CommLine commLine in settings.CommLines)
            {
                ...
                lineSubNodes.Add(
                    new TreeNode(CommShellPhrases.LineParamsNode)
                    {
                        ImageKey = "comm_params.png",
                        SelectedImageKey = "comm_params.png",
                        Tag = new TreeNodeTag()
                ...
                lineSubNodes.Add(
                    new TreeNode(CommShellPhrases.LineStatsNode)
                    {
                ...
                {
                    lineSubNodes.Add(
                        new TreeNode(string.Format(CommShellPhrases.DeviceNode, kp.Number, kp.Name))
                        {
            ...
            nodes.Add(
                new TreeNode(CommShellPhrases.StatsNode)
                {
                    ImageKey = "comm_stats.png",
                    SelectedImageKey = "comm_stats.png",
                    Tag = new TreeNodeTag()
