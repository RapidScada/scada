...
namespace Scada.Web
{
    ...
    /// <para>√енераци€ отчЄта "„асовые срезы и событи€"</para>
    /// </summary>
    public class RepHrEvTable : ExcelRepBuilder
    {
        private BaseView baseView;            // представление, по которому генерируетс€ отчЄт
        private TableView tableView;          // представление, приведЄнное к типу табличного представлени€
        private DateTime date;                // дата запрашиваемых данных
        private int eventOut;                 // тип вывода событий
        private DateTime genDT;               // дата и врем€ генерации отчЄта
        ...
        private TableView.Item item;          // обрабатываемый элемент представлени€
        ...
        /// <summary>
        /// ”становить параметры отчЄта.
        /// repParams[0] - табличное представление типа TableView,
        /// repParams[1] - дата запрашиваемых данных типа DateTime,
        /// repParams[2] - вывод событий типа int: 0 и меньше - не выводить, 1 - все событи€, иначе - по представлению
        /// </summary>
        ...
        /// <summary>
        /// Ќачальна€ обработка дерева XML-документа
        /// </summary>
        ...
        /// <summary>
        /// ќкончательна€ обработка дерева XML-документа
        /// </summary>
        ...
        /// <summary>
        /// ќбработка директивы, измен€ющей значение элемента
        /// </summary>
        /// <param name="xmlNode">XML-узел, содержащий директиву</param>
        /// <param name="valName">»м€ элемента, заданное директивой</param>
        ...
        /// <summary>
        /// ќбработка директивы, создающей строки таблицы
        /// </summary>
        /// <param name="xmlNode">XML-узел, содержащий директиву</param>
        /// <param name="rowName">»м€ строки, заданное директивой</param>
