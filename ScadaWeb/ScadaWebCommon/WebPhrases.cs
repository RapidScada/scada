...
namespace Scada.Web
{
    ...
    public static class WebPhrases
    {
        ...
        public static string DayCntExceeded { get; private set; }
        public static string DiagPageClosed { get; private set; }

        // Словарь Scada.Web.Diag.WFrmDiagCnls
        ...
        private static void SetToDefault()
        {
            ...
            DayCntExceeded = "Период должен быть не более {0} суток.";
        ...
        public static void Init()
        {
            ...
            if (Localization.Dictionaries.TryGetValue("Scada.Web.Diag", out dict))
            {
                ...
                DayCntExceeded = dict.GetPhrase("DayCntExceeded", DayCntExceeded);
                DiagPageClosed = dict.GetPhrase("DiagPageClosed", DiagPageClosed);
            }

            if (Localization.Dictionaries.TryGetValue("Scada.Web.Diag.WFrmDiagCnls", out dict))
            {
